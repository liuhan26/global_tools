function posPair=makePosPair(max_num,is_shuffle, ori_path, pair_path)
...
ori_label_num = ori_label;
pair_label_num = pair_label;
...
rand_thre=single(max_num)/total_pos_pair*1000;
pos_pair_count=1;
tic
